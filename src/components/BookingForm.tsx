...
const EMAILJS_SERVICE_ID = 'service_01xue5q';
const EMAILJS_ADMIN_TEMPLATE_ID = 'template_gmmulqx';
const EMAILJS_CUSTOMER_TEMPLATE_ID = 'template_cjinrb3';
const EMAILJS_PUBLIC_KEY = 'RyK63I486_4gqSP13';
